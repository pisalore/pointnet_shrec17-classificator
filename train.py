...
parser.add_argument('--batch_size', type=int, default=60, help='Batch Size during training [default: 32]')
...
TRAIN_FILES = provider.getDataFiles( \
    os.path.join(BASE_DIR, './data/hdf5_data/h5_filelist_training.txt'))
TEST_FILES = provider.getDataFiles(\
    os.path.join(BASE_DIR, './data/hdf5_data/h5_filelist_testing.txt'))
